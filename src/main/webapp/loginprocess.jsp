...
response.sendRedirect("user.jsp");
 ...
 <%
	...
	Class.forName("com.ibm.db2.jcc.DB2Driver");
		Connection con=DriverManager.getConnection("jdbc:db2://awh-yp-small02.services.dal.bluemix.net:50000/BLUDB","xxxxxx","xxxxx");String id=request.getParameter("id");	
